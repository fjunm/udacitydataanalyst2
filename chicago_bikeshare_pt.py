...
def column_to_list(data, index):
    """
      ...
      Argumentos:
          data: Dados 
          index: O index do dado inserido
      Retorna:
...
def count_gender(data_list):
    """
      ...
      Argumentos:
          data_list: Lista de dados para generos          
      Retorna:
          male: Quantidade de genero male
		  female: Quantidade de genero female 
    """
    male = 0
    female = 0
...
def count_userstypes(data_list):
    """
      Função de Contagem de Tipos de usuarios
      Argumentos:
          data_list: Lista de dados para generos          
      Retorna:
          subscriber: Quantidade de Subscriver
		  customer : Quantidade de Customer
		  dependent: Quantidade de Dependet
    """
    subscriber = 0
    customer = 0
    dependent = 0
    for i in range (len(data_list)):
        ...
        if userst[5] == 'Subscriber':
            ...
            customer += 1
        elif userst [5] == 'Dependent':
            dependent += 1			
    return [subscriber, customer, dependent]

print("\nTAREFA 7: Imprimindo o resultado de count_userstypes")
print(count_userstypes(data_list))

usertypes_list = column_to_list(data_list, -2)
types = ["Subscriber", "Customer", "Dependent"]
quantity = count_userstypes(data_list)
y_pos = list(range(len(types)))
plt.bar(y_pos, quantity)
plt.ylabel('Quantidade')
plt.xlabel('Users')
plt.xticks(y_pos, types)
plt.title('Quantidade por Users')
plt.show(block=True)
...
answer = "Pois há campo vazio que não é male nem female"
...
mean_trip = 0.
median_trip = 0.
orden_trip = sorted(trip_duration_list, key=int)

#print (orden_trip)
#Primeiro valor da lista ordenada
min_trip = int(orden_trip[0])

#Ultimo valor da lista ordenada
#max_trip = orden_trip[-1]
...
num_line = len(data_list)
#num_line += 1
if num_line % 2 == 0:
    value1 = int(num_line/2 + 1)
    value2 = int(num_line/2)
    median_value1 = int(orden_trip[value1])
